...
with gfile.FastGFile("./pb_model/frozen_model_v4.pb",
                     'rb') as f:
...
feature_map_1 = sess.graph.get_tensor_by_name('yolov4/yolov4_head/feature_map_1:0')
feature_map_2 = sess.graph.get_tensor_by_name('yolov4/yolov4_head/feature_map_2:0')
feature_map_3 = sess.graph.get_tensor_by_name('yolov4/yolov4_head/feature_map_3:0')
...
# inference
feature_1, feature_2, feature_3 = sess.run([feature_map_1, feature_map_2, feature_map_3], feed_dict={input: img})
# decode
pred_boxes, pred_confs, pred_probs = predict_numpy([feature_1, feature_2, feature_3])
