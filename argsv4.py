...
restore_path = './data/darknet_weights_v4/yolov4.ckpt'  # The path of the weights to restore.
...
# restore all layers except the last 3 conv2d layers(yolo layer)
restore_include = None
restore_exclude = ['yolov4/PANet/Conv_15', 'yolov4/PANet/Conv_23', 'yolov4/PANet/Conv_31']
# Choose the parts you want to finetune. List form.
# Set to None to train the whole model.
# update_part = ['yolov3/yolov3_head']
update_part = ["yolov4/PANet"]
