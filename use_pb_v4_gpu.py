...
img_size = [608, 608]
yolo_model = yolov4(class_num, anchors)
yolo_model.set_img_size(np.asarray(img_size))

sess = tf.Session(config=config)
with gfile.FastGFile("./pb_model/frozen_model_v4.pb",'rb') as f:
...
feature_map_1 = sess.graph.get_tensor_by_name('yolov4/PANet/feature_map_1:0')
feature_map_2 = sess.graph.get_tensor_by_name('yolov4/PANet/feature_map_2:0')
feature_map_3 = sess.graph.get_tensor_by_name('yolov4/PANet/feature_map_3:0')
