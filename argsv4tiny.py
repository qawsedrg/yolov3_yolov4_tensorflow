...
### Some paths
train_file = './data/my_data/train_hat.txt'  # The path of the training txt file.
val_file = './data/my_data/val_hat.txt'  # The path of the validation txt file.
#restore_path = './data/darknet_weights_v4tiny/'  # The path of the weights to restore.
...
anchor_path = './data/yolo_tiny_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/hat.names'  # The path of the class names.
...
lr_type = 'cosine_decay_restart'  # Chosen from [fixed, exponential, cosine_decay, cosine_decay_restart, piecewise]
...
# restore all layers except the last 2 conv2d layers(yolo layer)
restore_include = None
restore_exclude = ['yolov4tiny/head/Conv_3', 'yolov4tiny/head/Conv_6']
# Choose the parts you want to finetune. List form.
# Set to None to train the whole model.
update_part = ['yolov4tiny/head']
