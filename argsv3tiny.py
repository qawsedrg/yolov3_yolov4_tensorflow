...
#restore_path = './data/darknet_weights_v3tiny/'  # The path of the weights to restore.
...
restore_exclude = ['yolov3tiny/head/Conv_4', 'yolov3tiny/head/Conv_7']
# Choose the parts you want to finetune. List form.
# Set to None to train the whole model.
update_part = ['yolov3tiny/head']
